                ...
                <form action="{{ route('general.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <input type="Date" class="form-control @error('dateReceived') is-invalid @enderror"
                                            value="{{ old('dateReceived') }}" placeholder="Enter date" id="dateReceived"
                                            name="dateReceived" title="Date Received" min="2022-01-01" max="2099-12-31">
                            ...
                            <div class="col-md-4">
                                <label for="obligation">Obligation Request No.</label>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <input type="text" class="form-control @error('Obligation') is-invalid @enderror"
                                            value="{{ old('Obligation') }}" placeholder="Enter Obligation Request No."
                                            id="obligation" name="Obligation" title="Obligation Request No.">
                                        <div class="form-control-icon">
                                ...
                                <!--                placeholder="Disbursement Voucher No." id="disbursement" name="Disbursement" readonly>-->
                                <!--            <div class="form-control-icon">-->
                                <!--                <i class="bi bi-list-ol"></i>-->
                                <!--            </div>-->
                                <!--        </div>-->
