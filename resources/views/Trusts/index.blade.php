...
@if (Auth::user()->role=='Admin')
    <div class="d-flex align-items-center justify-content-between">
        <a href="{{ route('trust.create') }}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Add Trust Funds">Add Trust Funds</a>
    </div>
                ...
                <tr>
                        ...
                        <td class="align-middle">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                @if (Auth::user()->role=='Admin')
                                <a href="{{ route('trust.edit', $rs->id)}}" type="button" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit">Edit</a>
                                <a href="{{ route('trust.show.pdf', $rs->id) }}" type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Generate Reports" target="_blank">Generate Reports</a>
                                <form action="{{ route('trust.destroy', $rs->id) }}" method="POST" type="button" class="btn btn-danger p-0" onsubmit="return confirm('Delete?')"data-toggle="tooltip" data-placement="top" title="Delete">
                                    @csrf
                                    @method('DELETE')
                                    <button class="btn btn-danger m-0">Delete</button>
