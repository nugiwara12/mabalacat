...
@section('contents')
    ...
    <div class="row">
        <div class="col mb-3">
            ...
            <input type="text" name="created_at" class="form-control" placeholder="Created At" value="{{ $preaudits->created_at->setTimezone('Asia/Manila')->format('Y-m-d h:i A') }}" readonly>
        </div>
        <div class="col mb-3">
            <label class="form-label">Updated At</label>
            <input type="text" name="updated_at" class="form-control" placeholder="Updated At" value="{{ $preaudits->updated_at->setTimezone('Asia/Manila')->format('Y-m-d h:i A') }}" readonly>
        </div>
    </div>
@endsection